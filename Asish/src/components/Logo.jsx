...
/**
 * Professional NutriAI Logo Component
 * Recreates the branding from the reference image:
 * - Stylized "N" with integrated leaf
 * - Vertical divider (optional)
 * - "NutriAI" text with existing typography
 * - Subtext "YOUR PERSONAL NUTRITIONIST" (optional)
 */
    ...
    <div className={`flex items-center ${scale.gap} ${className}`}>
      ...
      {withText && (
        <div className="flex flex-col leading-none">
          ...
          {withSubtext && (
            <div 
              className="text-[10px] font-bold tracking-[0.1em] mt-1 uppercase"
